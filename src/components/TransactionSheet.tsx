                  ...
                  <button
                    ...
                    <div>
                      ...
                      <p style={{ fontSize: 11, color: "var(--ink-muted)", marginTop: 1 }}>
                        {catData?.name ? `Modificar "${catData.name}"` : "Sin categoría"}
                      </p>
                    </div>
                ...
                <div style={{ display: "flex", flexDirection: "column", gap: 10, paddingBottom: 4 }}>
                  ...
                  <div style={{ display: "flex", gap: 8, paddingTop: 8 }}>
                    <button onClick={() => setMode("view")}
                      style={{ flex: 1, padding: "13px", borderRadius: 12, fontSize: 13, background: "var(--raised)", color: "var(--ink-muted)", border: "0.5px solid var(--glass-border)" }}>
                      Cancelar
                    </button>
                    <button onClick={handleSave} disabled={saving || !desc.trim() || !amount}
                      style={{ flex: 1, padding: "13px", borderRadius: 12, fontSize: 13, fontWeight: 600, background: "var(--accent)", color: "#FFFFFF", opacity: saving ? 0.6 : 1 }}>
