...
export default function IconPicker({ selectedIcon, selectedColor, selectedStyle = "line", existingColors = [], onSelect, onClose }: Props) {
  ...
  const [pickedColor, setPickedColor] = useState(() => {
    ...
    // Auto-suggest: first color not in existingColors
  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* Color palette */}
        <div style={{ padding: "10px 18px 0" }}>
          <p style={{ fontSize: 10, fontWeight: 600, textTransform: "uppercase", letterSpacing: "0.07em", color: "var(--ink-muted)", marginBottom: 8 }}>Color de la categoría</p>
